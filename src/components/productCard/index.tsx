...
export default function ProductCard({ products }) { // Recebe os produtos como uma prop
    return (
        <div className="flex max-h-[400px] flex-wrap gap-10 lg:gap-5 mt-24 ml-10 min-w-[400px]">
            {products.map(product => (
                <div
                    key={product._id}
                    className="flex flex-col min-w-[400px] max-w-[375px] lg:w-[496px] relative border border-neutral-200 rounded-md hover:shadow-xl"
                >
                    <a
